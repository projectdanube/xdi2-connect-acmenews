...
<%@ page import="xdi2.connect.acmenews.AcmenewsConnectRequest" %>
...
<body>
	...
	<%
		String xdiMessageEnvelope = AcmenewsConnectRequest.connectRequest(request.getServletContext()).getMessageEnvelope().getGraph().toString("XDI/JSON", null);
	%>
